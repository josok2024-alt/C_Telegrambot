...
MIN_CONFIDENCE: int = 80        # minimum confidence (0-100) per model for a vote to count
...
# ---------------------------------------------------------------------------
# Instrument universe (30 symbols — Deriv symbol codes)
# Forex majors + Deriv synthetic indices, both tradeable 24/7.
# ---------------------------------------------------------------------------
INSTRUMENTS: List[str] = [
    # Forex majors (Deriv symbol format)
